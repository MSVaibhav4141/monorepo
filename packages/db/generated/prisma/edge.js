...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\VAIBHAV MS\\Desktop\\C3\\Web Dev\\week25\\week25.2\\week25\\packages\\db\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\VAIBHAV MS\\Desktop\\C3\\Web Dev\\week25\\week25.2\\week25\\packages\\db\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://neondb_owner:npg_aENfoQ8Hp1jL@ep-silent-morning-a4pxmtxl-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Todos {\n  id          Int      @id @default(autoincrement())\n  title       String\n  iscompleted Boolean  @default(false)\n  createdAt   DateTime @default(now())\n}\n",
  "inlineSchemaHash": "2749aad17e2b750c5904a59a429db681b7e981d3d329934dd334c29b575d31db",
  "copyEngine": true
}
config.dirname = '/'
